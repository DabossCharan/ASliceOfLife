...
public class AThirdCamera : MonoBehaviour
{
    private Camera cam;
    ...
    {
        // Move Right
        if (!camJustMoved && playerPos.x > 1)
        {
            currentOffset = new Vector3(orthographicWidth, 0, 0);
            camJustMoved = true;
            goingRight = true;
        ...
        // Move Left
        else if (!camJustMoved && playerPos.x < 0)
        {
            currentOffset = new Vector3(-orthographicWidth, 0, 0);
            camJustMoved = true;
            goingLeft = true;
        ...
        // Move Up
        if (!camJustMoved && playerPos.y > 1)
        {
            currentOffset = new Vector3(0, orthographicHeight, 0);
            camJustMoved = true;
            goingUp = true;
        ...
        // Move Down
        else if (!camJustMoved && playerPos.y < 0)
        {
            currentOffset = new Vector3(0, -orthographicHeight, 0);
            camJustMoved = true;
            goingDown = true;
